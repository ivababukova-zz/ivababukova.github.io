select
  City,
    ...
    sum(Education_Skills_and_Training_domain_2012_score1) as Sum_Education_Score_2012,
    ...
    sum(Education_Skills_and_Training_domain_2012_rank1) as Sum_Education_Rank_2012,
    ...
    sum(Working_age_no_qualifications_2001_2) as Sum_Working_Age_No_Qualifications,
    ...
    min(Pupil_Performance) as Minimum_Pupil_Performance,
    max(Pupil_Performance) as Maximum_Pupil_Performance,
    sum(Pupil_Performance) as Sum_Pupil_Performance,
    avg(Pupil_Performance) as Average_Pupil_Performance,
    ...
    sum(Total_Population__SAPE_2010) as Sum_Total_Population,
    ...
    sum(Income_domain_2012_rank) as Sum_Income_Rank,
    ...
    sum(Income_domain_2012_rate) as Sum_Income_Score,
    ...
    sum(Number_of_Income_Deprived_People_2012) as Sum_Number_of_Deprived,
    ...
    sum(Electorate_Referendum_2014) as Sum_Registered_Voters,
    ...
    sum(Estimated_population_2013) as Sum_Population,
    ...
    sum(Area_square_km) as Sum_Area_km,
